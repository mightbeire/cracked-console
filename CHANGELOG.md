...
## Unreleased — Weekly Mastery, Teacher Shelf, and Self-Paced Paths
...
- optional weekly Teacher Shelf through non-required `WEEK_RESOURCE_*` metadata blocks;
- Teacher Shelf cards for primary teaching, visual, interactive, lab, rescue, and reference roles, with plan-owned segment/use/notice metadata;
...
- neutral side-path and Teacher Shelf examples included in release checks;
- Teacher Shelf metadata parsing regression tests;
...
- weekly resource metadata is rendered separately from ordinary weekly-contract prose;
...
- resource consumption never counts as week proof;
